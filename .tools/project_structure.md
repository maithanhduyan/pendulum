...
<html lang="en">
  ...
  <body>
    ...
    <script type="module" src="lib/neat/neatjs.js"></script>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function loadBestGenome() {
    ...
    if (savedGenome) {
      ...
      const genome = NeatJS.Network.fromJSON(genomeData);
      return genome;
    }
    return null;
  }
